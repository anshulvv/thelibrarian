// elm-watch hot {"version":"1.1.3","targetName":"Target: all","webSocketPort":63517}
"use strict";
(() => {
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{bookSearchStatus: $author$project$Model$NoOp, error: $elm$core$Maybe$Nothing, searchInput: $elm$core$Maybe$Nothing},
...
var $author$project$View$viewSearchBookCard = function (bookInfo) {
	var viewThumbnail = function (url) {
		return A2(
			$mdgriffith$elm_ui$Element$image,
			_List_fromArray(
				[
...
var $author$project$View$viewSearchBox = function (model) {
	return A2(
...
var $author$project$View$viewHelper = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$View$viewSearchBox(model),
				$author$project$View$viewBookSearchResults(model),
				A2(
				$mdgriffith$elm_ui$Element$paragraph,
				_List_Nil,
				_List_fromArray(
...
var $author$project$View$view = function (model) {
	return A2(
		...
		_List_Nil,
		$author$project$View$viewHelper(model));
};
